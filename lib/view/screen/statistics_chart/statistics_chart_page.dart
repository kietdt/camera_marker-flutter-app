...
import 'statistics_chart_ctr.dart';

class StatisticsChartPagePayload {
  final Exam? exam;

  StatisticsChartPagePayload({this.exam});
}

class StatisticsCharPage extends StatefulWidget {
  final StatisticsChartPagePayload? payload;

  const StatisticsCharPage({Key? key, this.payload}) : super(key: key);
...
class StatisticsChartState
    extends BaseScaffold<StatisticsCharPage, StatisticsChartCtr> {
  @override
  StatisticsChartCtr initController() {
    return StatisticsChartCtr(this);
  }
